...
public class Comprobador {
	...
	public static void main(String[] args) throws IOException, InvocationTargetException, InterruptedException {		
		//test("C:/hlocal/Wspace/Prac6/examples/cruces_avanzados");
		//test("C:/hlocal/workspace-4.4-64bits/Prac6/examples/advanced");
		test("/home/jaime/Documentos/WORKSPACES/WORKSPACE JAVA/Prac6/examples/cruces_avanzados/");
	}
